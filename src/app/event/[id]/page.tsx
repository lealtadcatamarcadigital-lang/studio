...
const parseWrestlers = (match: string): { text: string; wrestler: boolean }[] => {
    ...
    const wrestlerNames = new Set([
        ...
        "Bubba Ray Dudley", "D-Von Dudley", "Rikishi", "Tazz", "Al Snow", "Test", "Albert", "Big Boss Man", "Hardcore Holly", "Crash Holly", "The Godfather", 
        ...
        "The Kat", "The Fabulous Moolah", "Mae Young", "The Mean Street Posse", "Joey Abs", "Pete Gas", "Rodney", "Too Cool", "Prince Albert", "The New Age Outlaws"
    ]);
