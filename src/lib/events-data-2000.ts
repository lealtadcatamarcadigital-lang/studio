...
export const WWF_2000_DATA: MonthData[] = [
  ...
  },
  {
    ...
    ppvs: [
      { date: '27', name: 'No Way Out', location: 'Hartford, CT', description: 'Triple H derrota a Cactus Jack en un Hell in a Cell para retener el título y retirar a Mick Foley. The Big Show derrota a The Rock.', matches: ['Hell in a Cell for WWF Championship: Triple H vs. Cactus Jack', 'The Rock vs. The Big Show'], coverUrl: 'https://upload.wikimedia.org/wikipedia/en/8/8a/No_Way_Out_2000.jpg' },
    ],
  },
  {
    month: 'Marzo',
